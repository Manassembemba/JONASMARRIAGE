...
export function generateInvitationPdf(
  ...
  doc.setFontSize(11);
  doc.setTextColor(27, 28, 26);
  doc.text(details.date1 || 'Jeudi 29 Octobre 2026', col1X + ceremonyBoxW / 2, currentY + 18, { align: 'center' });
  ...
  doc.setFontSize(11);
  doc.setTextColor(27, 28, 26);
  doc.text(details.date2 || 'Samedi 31 Octobre 2026', col2X + ceremonyBoxW / 2, currentY + 18, { align: 'center' });
